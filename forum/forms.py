...
class CommentForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['text'].widget.attrs.update({'class':'input block p-2.5 w-full text-sm rounded-lg border bg-gradient-to-t from-slate-700 to-blue-950 border-slate-600 placeholder-slate-400 text-white focus:ring-blue-500 focus:border-blue-500 relative'})
